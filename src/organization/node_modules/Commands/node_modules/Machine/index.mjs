...
export default class Machine {
  ...
  try{
    ...
    const inputResponse = await screen.input({name: 'human-sez', message:'Say something!', initial:"Hola!"})

    await screen.info(`De hooman sez "${JSON.stringify(inputResponse)}" and chozes "${JSON.stringify(selectresponse)}, beep bop."`);
